...
import com.valenpatel.vatavarana.databinding.ActivityMain2Binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.feedbackView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.valenpatel.vatavarana&pcampaignid=web_share"));
        ...
        binding.privacyView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://laidbackvalen.github.io/VatavaranPP/"));
                startActivity(intent);
            }
        });
        ...
        binding.termsView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://laidbackvalen.github.io/VatavaranTnC/"));
                startActivity(intent);
            }
        });
    }
